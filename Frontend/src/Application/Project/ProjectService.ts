...
export default class ProjectService {
  ...
  public emitUpdateNode(node: any) {
    this.socket.emit('updateNode', node);
  }

  public emitDeleteNode(node: any) {
    this.socket.emit('deleteNode', node);
  }

  public emitCreateNode(node: any) {
    this.socket.emit('createNode', node);
  }
